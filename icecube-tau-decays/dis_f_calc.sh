...
for energy in "${energies[@]}"; do
    ...
    genie -l -b -q "crv98lo_pdf.C(\"../data/test_genie_NuTau_${energy}.0_GeV_event_info_f.csv\",\"../data/test_genie_NuTau_${energy}.0_GeV_event_info_pdf.csv\",true)"
